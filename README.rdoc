...
Sign up certification strategy for devise[http://github.com/plataformatec/devise]. New sign ups need to be certified before they can sign in. After sign up an email is sent to the email address specified in the devise configuration.
